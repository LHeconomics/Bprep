...
# %% {"tags": [], "jupyter": {"source_hidden": true, "outputs_hidden": true}, "collapsed": true}
# SOLUTION
...
cMinLabel = r'Lower Bound: $\underline{c}(m)= (1-\pmb{\text{\TH}}_{\mathsf{R}})\underline{\kappa}m$'
if not latexExists:
...
kappaDef = r'$\underline{\kappa}\equiv(1-\pmb{\text{\TH}}_{\mathsf{R}})$'
if not latexExists:
