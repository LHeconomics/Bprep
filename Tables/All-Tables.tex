...
\input{./econtexRoot}\documentclass[\econtexRoot/Bprep]{subfiles}
\input{./econtexRoot}\input{\LaTeXInputs/econtex_onlyinsubfile}
\onlyinsubfile{\externaldocument{\LaTeXGenerated/Bprep}}
\begin{document}

\input{\TableDir/Table_1}
\input{\TableDir/Table_2}
\input{\TableDir/Table_3}
